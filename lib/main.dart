...
class MyHomePageIcon extends StatelessWidget {
  MyHomePageIcon({Key? key, required this.title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(this.title)),
      body: Center(child: Icon(Icons.access_alarm)),
    );
  }
}

class MyHomePageTest extends StatelessWidget {
  MyHomePageTest({Key? key, required this.title}) : super(key: key);
